...
const features = [
  {
    ...
    imageAlt: "Faróis de carro iluminando estrada à noite",
  ...
  },
  {
    ...
    imageAlt: "Carro esportivo vermelho em showroom",
    colorClass: "bg-brand-blue/10 text-brand-blue",
  },
  {
    icon: (
    ...
    imageAlt: "Pessoa dirigindo carro moderno",
  ...
  },
  {
    ...
    imageAlt: "Fileira de carros em estacionamento de concessionária",
  ...
  },
  {
    ...
    imageAlt: "Carro branco moderno em rodovia",
  ...
  },
  {
    ...
    imageAlt: "Painel de instrumentos de carro moderno",
    colorClass: "bg-brand-pink/10 text-brand-pink",
  },
  {
    icon: (
